...
;metodos_ds1307.h,21 :: 		I2C1_Wr(direccion_esclavo+1);
	...
	MOVWF       FARG_I2C1_Wr_data_+0 
	CALL        _I2C1_Wr+0, 0
;metodos_ds1307.h,24 :: 		delay_ms(200);
	MOVLW       6
	MOVWF       R11, 0
	MOVLW       19
	MOVWF       R12, 0
...
;metodos_ds1307.h,28 :: 		I2C1_Stop();
	CALL        _I2C1_Stop+0, 0
;metodos_ds1307.h,30 :: 		delay_ms(200);
	MOVLW       6
	MOVWF       R11, 0
	MOVLW       19
	MOVWF       R12, 0
...
;M_RGB_1.c,28 :: 		void main()
;M_RGB_1.c,30 :: 		config();
	CALL        _config+0, 0
;M_RGB_1.c,33 :: 		while(1)
L_main48:
;M_RGB_1.c,37 :: 		temperature = getTemperature();
...
;M_RGB_1.c,38 :: 		floattostr(temperature, txt);
	MOVF        R0, 0 
...
;M_RGB_1.c,39 :: 		UART1_Write_Text("TEMPERATURE: ");
	MOVLW       ?lstr5_M_RGB_1+0
	MOVWF       FARG_UART1_Write_Text_uart_text+0 
	MOVLW       hi_addr(?lstr5_M_RGB_1+0)
	MOVWF       FARG_UART1_Write_Text_uart_text+1 
	CALL        _UART1_Write_Text+0, 0
;M_RGB_1.c,40 :: 		UART1_Write_Text(txt);
	MOVLW       _txt+0
	MOVWF       FARG_UART1_Write_Text_uart_text+0 
	MOVLW       hi_addr(_txt+0)
	MOVWF       FARG_UART1_Write_Text_uart_text+1 
	CALL        _UART1_Write_Text+0, 0
;M_RGB_1.c,41 :: 		uart1_write_text("°C\r\n");
	MOVLW       ?lstr6_M_RGB_1+0
	MOVWF       FARG_UART1_Write_Text_uart_text+0 
	MOVLW       hi_addr(?lstr6_M_RGB_1+0)
	MOVWF       FARG_UART1_Write_Text_uart_text+1 
	CALL        _UART1_Write_Text+0, 0
;M_RGB_1.c,44 :: 		delay_ms(500);
	MOVLW       13
	MOVWF       R11, 0
	MOVLW       175
	MOVWF       R12, 0
...
L_main50:
	...
	BRA         L_main50
	NOP
;M_RGB_1.c,47 :: 		humidity = getHumidity();
	...
	MOVF        R3, 0 
	MOVWF       _humidity+3 
;M_RGB_1.c,48 :: 		floattostr(humidity, txt);
	MOVF        R0, 0 
	MOVWF       FARG_FloatToStr_fnum+0 
	MOVF        R1, 0 
	MOVWF       FARG_FloatToStr_fnum+1 
	...
	MOVWF       FARG_FloatToStr_str+1 
	CALL        _FloatToStr+0, 0
;M_RGB_1.c,49 :: 		UART1_Write_Text("HUMEDAD: ");
	MOVLW       ?lstr7_M_RGB_1+0
	MOVWF       FARG_UART1_Write_Text_uart_text+0 
	MOVLW       hi_addr(?lstr7_M_RGB_1+0)
	MOVWF       FARG_UART1_Write_Text_uart_text+1 
	CALL        _UART1_Write_Text+0, 0
;M_RGB_1.c,50 :: 		UART1_Write_Text(txt);
	MOVLW       _txt+0
	MOVWF       FARG_UART1_Write_Text_uart_text+0 
	MOVLW       hi_addr(_txt+0)
	MOVWF       FARG_UART1_Write_Text_uart_text+1 
	CALL        _UART1_Write_Text+0, 0
;M_RGB_1.c,51 :: 		uart1_write_text("%\r\n");
	MOVLW       ?lstr8_M_RGB_1+0
	MOVWF       FARG_UART1_Write_Text_uart_text+0 
	MOVLW       hi_addr(?lstr8_M_RGB_1+0)
	MOVWF       FARG_UART1_Write_Text_uart_text+1 
	CALL        _UART1_Write_Text+0, 0
;M_RGB_1.c,55 :: 		delay_ms(500);
	MOVLW       13
	MOVWF       R11, 0
	MOVLW       175
	MOVWF       R12, 0
...
L_main51:
	...
	BRA         L_main51
	NOP
;M_RGB_1.c,58 :: 		UART1_Write_Text("Drops: ");
	MOVLW       ?lstr9_M_RGB_1+0
	MOVWF       FARG_UART1_Write_Text_uart_text+0 
	MOVLW       hi_addr(?lstr9_M_RGB_1+0)
	MOVWF       FARG_UART1_Write_Text_uart_text+1 
	CALL        _UART1_Write_Text+0, 0
;M_RGB_1.c,59 :: 		drops = TMR0L;
	MOVF        TMR0L+0, 0 
	MOVWF       _drops+0 
	MOVLW       0
	MOVWF       _drops+1 
;M_RGB_1.c,60 :: 		drops |=  (TMR0H << 8);
	MOVF        TMR0H+0, 0 
	MOVWF       R1 
	CLRF        R0 
	MOVF        _drops+0, 0 
	...
	MOVF        R1, 0 
	MOVWF       _drops+1 
;M_RGB_1.c,61 :: 		inttostr(drops, txt);
	MOVF        R0, 0 
	...
	CALL        _IntToStr+0, 0
;M_RGB_1.c,62 :: 		UART1_Write_Text(txt);
	MOVLW       _txt+0
	MOVWF       FARG_UART1_Write_Text_uart_text+0 
	MOVLW       hi_addr(_txt+0)
	MOVWF       FARG_UART1_Write_Text_uart_text+1 
	CALL        _UART1_Write_Text+0, 0
;M_RGB_1.c,63 :: 		uart1_write_text("\r\n");
	MOVLW       ?lstr10_M_RGB_1+0
	MOVWF       FARG_UART1_Write_Text_uart_text+0 
	MOVLW       hi_addr(?lstr10_M_RGB_1+0)
	MOVWF       FARG_UART1_Write_Text_uart_text+1 
	CALL        _UART1_Write_Text+0, 0
;M_RGB_1.c,67 :: 		delay_ms(500);
	MOVLW       13
	MOVWF       R11, 0
	MOVLW       175
	MOVWF       R12, 0
...
L_main52:
	...
	BRA         L_main52
	NOP
;M_RGB_1.c,71 :: 		UART1_Write_Text("Time: ");
	MOVLW       ?lstr11_M_RGB_1+0
	MOVWF       FARG_UART1_Write_Text_uart_text+0 
	MOVLW       hi_addr(?lstr11_M_RGB_1+0)
	MOVWF       FARG_UART1_Write_Text_uart_text+1 
	CALL        _UART1_Write_Text+0, 0
;M_RGB_1.c,72 :: 		for(i=1; i<=6; i++)
	MOVLW       1
	MOVWF       _i+0 
L_main53:
	MOVF        _i+0, 0 
	...
	BTFSS       STATUS+0, 0 
	GOTO        L_main54
;M_RGB_1.c,74 :: 		time = Leer(ADDRESS_RTC,i);
	MOVLW       208
	...
	MOVF        R1, 0 
	MOVWF       _time+1 
;M_RGB_1.c,76 :: 		time = Bcd2Dec(time);
	MOVF        R0, 0 
	...
	MOVLW       0
	MOVWF       _time+1 
;M_RGB_1.c,77 :: 		UART1_Write( (time/10) + 48 );
	MOVLW       10
	MOVWF       R4 
	MOVLW       0
	MOVWF       R5 
...
;M_RGB_1.c,88 :: 		void config (void)
;M_RGB_1.c,92 :: 		TRISB.F7=0;
	BCF         TRISB+0, 7 
;M_RGB_1.c,93 :: 		TRISB.F6=0;
	BCF         TRISB+0, 6 
;M_RGB_1.c,94 :: 		TRISB.F5=0;
	BCF         TRISB+0, 5 
;M_RGB_1.c,97 :: 		T0CON = 0XA8;
	MOVLW       168
	MOVWF       T0CON+0 
;M_RGB_1.c,98 :: 		TMR0L = 0X00;
	CLRF        TMR0L+0 
;M_RGB_1.c,99 :: 		TMR0H = 0X00;
	CLRF        TMR0H+0 
;M_RGB_1.c,100 :: 		TRISA.F4 = 1;
	BSF         TRISA+0, 4 
;M_RGB_1.c,102 :: 		ANSELC=0;
	CLRF        ANSELC+0 
;M_RGB_1.c,103 :: 		ANSELA=0;
	CLRF        ANSELA+0 
;M_RGB_1.c,104 :: 		TRISC =0;
	CLRF        TRISC+0 
;M_RGB_1.c,105 :: 		TRISA =0;
	CLRF        TRISA+0 
;M_RGB_1.c,108 :: 		UART1_Init(9600);               // Initialize UART module at 9600 bps
	BSF         BAUDCON+0, 3, 0
	MOVLW       2
	MOVWF       SPBRGH+0 
	MOVLW       8
...
;M_RGB_1.c,109 :: 		Delay_ms(100);                  // Wait for UART module to stabilize
	MOVLW       3
	MOVWF       R11, 0
	MOVLW       138
	MOVWF       R12, 0
...
L_config56:
	...
	NOP
	NOP
;M_RGB_1.c,111 :: 		UART1_Write_Text("Configuration init: ");
	MOVLW       ?lstr14_M_RGB_1+0
	MOVWF       FARG_UART1_Write_Text_uart_text+0 
	MOVLW       hi_addr(?lstr14_M_RGB_1+0)
	MOVWF       FARG_UART1_Write_Text_uart_text+1 
	CALL        _UART1_Write_Text+0, 0
;M_RGB_1.c,112 :: 		uart1_write_text("\r\n");
	MOVLW       ?lstr15_M_RGB_1+0
	MOVWF       FARG_UART1_Write_Text_uart_text+0 
	MOVLW       hi_addr(?lstr15_M_RGB_1+0)
	MOVWF       FARG_UART1_Write_Text_uart_text+1 
	CALL        _UART1_Write_Text+0, 0
;M_RGB_1.c,115 :: 		th02Init();
	CALL        _th02Init+0, 0
;M_RGB_1.c,116 :: 		Accelconfig();
